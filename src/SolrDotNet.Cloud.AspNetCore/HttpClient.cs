...
public static class HttpClientSolrNet
    {
        /// <summary>
        /// Gets basic server instance
        /// </summary>
        public static ISolrBasicOperations<T> GetBasicServer<T>(string url, IHttpClientFactory factory)
        {
            var connection = new HttpClientSolrConnection(url, factory);
        ...
        /// </summary>
        public static ISolrOperations<T> GetServer<T>(string url, IHttpClientFactory factory)
        {
            var connection = new HttpClientSolrConnection(url, factory);
